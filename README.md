...
### Các dịch vụ còn lại của dự án

Danh sách các dịch vụ:

- Dịch vụ code-payment-service
- Dịch vụ code-document-service
- Dịch vụ code-document-worker
- Dịch vụ code-persona-service
- Dịch vụ code-conversation-service
- Dịch vụ code-chatbot-service

GitHub Actions sẽ tự động xây dựng Docker Image và đẩy lên Docker Hub. Cấu hình thay đổi Docker Image mới trong gitops-argocd.
